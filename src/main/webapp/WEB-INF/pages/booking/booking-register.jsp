  ...
  <div class="cmn-inner clearfix">
    ...
    <div class="right">
      <form:form action="booking-success" method="post"
        ...
        <table>
          <tr>
            <td><label for="roomNum">Number of Room : </label></td>
            <td><form:input type="number" path="roomNum" min="1"
                max="${room.avaRoom}" required="required" /></td>
          </tr>
          <tr>
            <td><label for="checkIn">CheckIn:</label></td>
            <td><form:input type="date" path="checkIn"
                required="required" /></td>
          </tr>
          <tr>
            <td><label for="checkOut">CheckOut:</label></td>
            <td><form:input type="date" path="checkOut"
                required="required" /></td>
          </tr>
          <tr>
            <td><label for="nrc">Nrc:</label></td>
            <td><form:input path="nrc" required="required"
                pattern="\d{1,2}/[a-zA-Z]+\([a-zA-Z]\)\d{6}"
                title="Please enter a valid Myanmar NRC number! like 12/ThaKaNa(N)345678'" /></td>
          </tr>
          <tr>
