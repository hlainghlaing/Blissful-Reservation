  ...
  <div class="cmn-inner">
    ...
    <form:form action="save" method="post" modelAttribute="user">
      <table><tr><td>
        ...
        <form:input path="userName" required="required" /></td></tr>
        <tr><td> <label for="email">Email:</label></td><td>
        <form:input path="email" required="required" /></td></tr>
        ...
        <tr><td><label for="phoneNo">Phone No:</label></td><td>
        <form:input path="phoneNo" required="required" /></td></tr>
         <tr><td><input class="cmn-btn" type="submit" value="Register"></td></tr>
    </table>
    </form:form>
  </div>
</section>